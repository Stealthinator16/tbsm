...
export default async function AlbumPage({ params }: PageProps) {
  ...
  return (
    <main className="min-h-screen py-24 px-6 max-w-7xl mx-auto relative z-10">
      {/* Header */}
      <div className="flex flex-col md:flex-row items-end gap-12 mb-24 border-b border-zinc-900 pb-12">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-8xl md:text-[10rem] font-black font-oswald uppercase text-white tracking-tighter leading-[0.8] mb-6">
            {album.title}
          </h1>
          <div className="flex gap-12 font-mono text-zinc-500 uppercase tracking-widest text-sm">
        ...
        <div className="grid gap-2">
          {albumSongs.map((song, idx) => (
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="text-4xl font-bold font-oswald uppercase text-zinc-400 group-hover:text-white transition-colors tracking-tight">
                  {song.title}
                </h3>
              </div>
